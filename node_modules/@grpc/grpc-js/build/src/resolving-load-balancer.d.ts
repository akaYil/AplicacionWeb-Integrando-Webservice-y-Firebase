...
export declare class ResolvingLoadBalancer implements LoadBalancer {
     ...
     */
<<<<<<< HEAD
    constructor(target: GrpcUri, channelControlHelper: ChannelControlHelper, credentials: ChannelCredentials, channelOptions: ChannelOptions, onSuccessfulResolution: ResolutionCallback, onFailedResolution: ResolutionFailureCallback);
=======
